        ...
        <div className="inner">
          <div className="front">
            ...
            <div className="poster">
              <img src="img/YiSbqEf6OvFcDoLoQCipDojOHqMCwKG4_420.jpg" alt="주토피아" />
            </div>
            <div className="screen_type">
              <img src="img/type_mega_mx4d.png" alt="Mega MX4D" />
              <img src="img/type_dolbycinema.png" alt="Dolby Cinema" />
              <img src="img/type_dolbyatmos.png" alt="Dolby Atmos" />
            </div>
            <div className="grade">
              <img src="img/ALL_56x56.png" alt="Movie Grade All" />
            </div>
          </div>
          <div className="back">
