...
import kr.co.subway.member.dto.MemberDTO;
import kr.co.subway.member.service.MemberService;
...
public class MemberController {
    ...
    public String register(@ModelAttribute MemberDTO dto, HttpSession session) {
        ...
        if (isSuccess) {
            ...
            return "redirect:/member/join/success"; // PRG 패턴 적용
        } else {
    ...
    public String registerProcess() {
        return "member/joinSuccess"; // WEB-INF/views/member/joinSuccess.jsp
    }
}