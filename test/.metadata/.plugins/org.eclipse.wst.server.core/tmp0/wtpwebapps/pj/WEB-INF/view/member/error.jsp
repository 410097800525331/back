...
<div id="error">
	<div>
		<img src="${pageContext.request.contextPath}/static/assets/img/logo_w.png" alt="logo">
		<c:choose>
	        <%-- 404 에러일 경우 --%>
	...
	<div>
		<img src="${pageContext.request.contextPath}/static/assets/img/robot.png" alt="error">
	</div>
