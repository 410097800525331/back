...
public class DBConnectionMgr {
    ...
    //private static final String URL = "jdbc:mysql://localhost:3306/testdb?useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true&characterEncoding=UTF-8";
    // 서버 테스트
    private static final String URL = "jdbc:mysql://mysql-subwaykr.alwaysdata.net:3306/subwaykr_db2?useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true&characterEncoding=UTF-8";
    
    // 2. 데이터베이스 계정 정보
    private static final String USER = "subwaykr";      // MySQL 사용자 계정
    private static final String PASSWORD = "subwaykr_db1234"; // 해당 계정의 비밀번호
